...
class Referrer:
    ...
    def has_request(self, request):
        ...
        Note that it is possible for has_request() to return True even though
        the request in question is not generated by iter_requests().
        """
...
class Redirect(Referrer):
    ...
    def __init__(self, request):
        Referrer.__init__(self, request.page_url)
        self.target = request
